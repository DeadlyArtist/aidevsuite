...
const samples = ['data/Fetch.json', 'data/Simple Chat.json', 'data/Chat.json', 'data/Encoder.json', 'data/Word Counter.json', 'data/Image To DataURL.json', 'data/Live Calculator.json'];
